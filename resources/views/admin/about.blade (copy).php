  ...
  <div class="row">
			...
			<div class="row">
			  <div class="col-3">
				<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
				  ...
				  <a class="nav-link" id="v-pills-section5-tab" data-toggle="pill" href="#v-pills-section5" role="tab" aria-controls="v-pills-section5" aria-selected="false">Section 5</a>
	...
	<div class="col-9">
	   <div class="tab-content" id="v-pills-tabContent">
		...
		<!-- Section 1 Start -->
		<div class="tab-pane fade" id="v-pills-section1" role="tabpanel" aria-labelledby="v-pills-section1-tab">
		<div class="tab-pane fade show active" id="v-pills-section1" role="tabpanel" aria-labelledby="v-pills-section1-tab">
		   <form method="post" action="{{route('addPageSectionContent')}}" enctype="multipart/form-data">
			...
			<div class="row">
			    ...
			    <div class="col-md-6 mb-1">
				@if($about[0]->bg_img)
				 <img src="{{$about[0]->bg_img}}" width="100" height="70" style="border: 1px solid #000;"></img>
				@endif
			    </div>
			...
			<div id="full-wrapper">
				<div id="full-container1">
					<div class="editor">
						<?php if($about[0]->content){ echo $about[0]->content; }else{ '';} ?>	
					</div>
				</div>
			</div>
