	...
	<div class="col-9">
	   <div class="tab-content" id="v-pills-tabContent">
		...
		<!-- Section 1 Start -->
		   ...
		   <form method="post" action="{{route('addServices')}}" enctype="multipart/form-data">
			@csrf
			<div class="row">
				...
				<textarea class="quill_editor2 form-control" name="subtitle" id="subtitle1">{{($servicesedit[0]->short_content ?? '')}}</textarea>
			    </div>
			  ...
			  <div class="col-md-6 mb-1">
			    ...
			    <div class="col-md-12 mb-1">
			    <label for="con">Long Content:</label>
				<textarea class="quill_editor1 form-control" name="content" id="con">{{($servicesedit[0]->content ?? '')}}</textarea>
			</div>
								
			</div>

			<div>
			<input type="hidden" value="{{($servicesedit[0]->id ?? '')}}" name="id"></input>
				<button class="btn btn-primary" type="submit" style="margin-top: 10px; float:right;">Add Services</button>
			</div>
		</form>
