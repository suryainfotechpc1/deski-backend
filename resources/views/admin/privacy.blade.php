		...
		<!-- Section 1 Start -->
		   ...
		   <form method="post" action="{{route('addPageSectionContent')}}" enctype="multipart/form-data">
			...
			<div class="row">
				...
				<input type="text" class="form-control" value="{{$privacy[0]->title}}" name="title" id="title1" placeholder="Title">
			    </div>
								
			    <div class="col-md-6 mb-1">
				<label for="subtitle1">Subtitle:</label>
				<input type="text" class="form-control" value="{{$privacy[0]->subtitle}}" name="subtitle" id="subtitle1" placeholder="Subtitle">
			    </div>
								
			</div>
			<div id="full-wrapper">
				<textarea class="quill_editor3" name="section_content">{{$privacy[0]->content}}</textarea>
			</div>
