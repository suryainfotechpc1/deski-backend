...
// Route::group(['prefix' => 'admin'], function () {
	...
	Route::post('addSliderImage',[AdminController::class, 'addSliderImage'])->name('addSliderImage');
	Route::get('deleteSlider/{id}',[AdminController::class, 'deleteSlider'])->name('deleteSlider');
	
	Route::get('contact',[AdminController::class, 'getContact']);
	Route::post('addSectionContent',[AdminController::class, 'addSectionContent'])->name('addSectionContent');
	
	Route::post('addPageSectionContent',[AdminController::class, 'addPageSectionContent'])->name('addPageSectionContent');
	Route::post('saveWhatWeDo',[AdminController::class, 'saveWhatWeDo'])->name('saveWhatWeDo');
	
	Route::get('about',[AdminController::class, 'getAbout']);
	Route::post('saveAboutFounder',[AdminController::class, 'saveAboutFounder'])->name('saveAboutFounder');
	
	Route::get('portfolio',[AdminController::class, 'getPortfolio']);
	...
	Route::post('addPortfolio',[AdminController::class, 'addPortfolio'])->name('addPortfolio');
	Route::get('deletePortfolio/{id}',[AdminController::class, 'deletePortfolio'])->name('deletePortfolio');
	
	Route::get('add_portfolio',[AdminController::class, 'add_portfolio'])->name('add_portfolio');
	Route::get('view_portfolio',[AdminController::class, 'getViewPortfolio']);
	Route::get('add_portfolio/{id}',[AdminController::class, 'add_portfolio'])->name('add_portfolio');

	
	Route::get('solution',[AdminController::class, 'getSolution']);
	
	Route::get('terms',[AdminController::class, 'getTerms']);
	
	Route::get('privacy',[AdminController::class, 'getPrivacy']);
	
	Route::get('blog',[AdminController::class, 'getBlog']);
	Route::get('add_blog',[AdminController::class, 'add_blog'])->name('add_blog');
	Route::get('view_blog',[AdminController::class, 'getViewBlog']);
	Route::get('add_blog/{id}',[AdminController::class, 'add_blog'])->name('add_blog');
	
	
	
	Route::get('services',[ServicesController::class, 'getServicesPage']);
	Route::post('saveServices',[AdminController::class, 'saveServices'])->name('saveServices');
	Route::get('add_services',[ServicesController::class, 'getServices']);
	Route::post('addServices',[ServicesController::class, 'addServices'])->name('addServices');
	Route::get('deleteServices/{id}',[ServicesController::class, 'deleteServices'])->name('deleteServices');
	Route::get('getServices/{id}',[ServicesController::class, 'getServices'])->name('getServices');
	Route::get('view_services',[ServicesController::class, 'getViewServices']);
