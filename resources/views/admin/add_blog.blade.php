		...
		<!-- Section 1 Start -->
		   ...
		   <form method="post" action="{{route('addPortfolio')}}" enctype="multipart/form-data">
			...
			<div class="row">
				...
				<select class="form-control" value="" name="subtitle" id="subtitle1" placeholder="category">
			...
			<div>
				...
				<input type="hidden" id="edit_id" name="type" value="blog" >
				<button class="btn btn-primary" type="submit" style="margin-top: 10px; float:right;">Add Blog</button>
			</div>
		</form>
