    ...
    <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation" data-icon-style="lines">
		...
		<li class="nav-item">
			<a href="{{asset('category')}}">
				<span class="menu-title text-truncate">Add Category</span>
			</a>
		</li>
		<li class="nav-item">
			<a href="{{asset('portfolio')}}">
				<span class="menu-title text-truncate">Our Portfolio</span>
			</a>
			<ul>
				<li>
					<a href="{{asset('portfolio')}}">
				...
				<li>	
					<a href="{{asset('add_portfolio')}}">
						<span class="menu-title text-truncate">Add Portfolio</span>
					</a>
				</li>
				<li>
					<a href="{{asset('view_portfolio')}}">
						<span class="menu-title text-truncate">Manage Portfolio</span>
					</a>
				</li>	
			</ul>
		</li>
		...
		<li class="nav-item">
			...
			<ul>
				...
				<li>	
					<a href="{{asset('add_services')}}">
						<span class="menu-title text-truncate">Add Services</span>
					</a>
				</li>
				<li>
					<a href="{{asset('view_services')}}">
						<span class="menu-title text-truncate">Manage Services</span>
					</a>
				</li>	
			</ul>
		</li>
		...
		<li class="nav-item">
			<a href="{{asset('solution')}}">
				<span class="menu-title text-truncate">Our Solutions</span>
			</a>
		</li>
		...
		<li class="nav-item">
			...
			<ul>
				...
				<li>	
					<a href="{{asset('add_blog')}}">
						<span class="menu-title text-truncate">Add Blog</span>
					</a>
				</li>
				<li>
					<a href="{{asset('view_blog')}}">
						<span class="menu-title text-truncate">Manage Blog</span>
					</a>
				</li>	
			</ul>
		</li>
		...
		<li class="nav-item">
			<a href="{{asset('terms')}}">
				<span class="menu-title text-truncate">Terms and condition</span>
			</a>
		</li>
